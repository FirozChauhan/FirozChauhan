...
<p style="margin-top: 6px;">Full-stack developer from India. I build self-hosted APIs, backend systems, polished frontends, and Linux utilities (Arch btw) — with a stubborn belief that everything should degrade gracefully instead of crashing. RAG and the cutie paradox of Local LLMs.</p>
...
![Docker](https://img.shields.io/badge/Docker-161B22?style=for-the-badge&logo=docker&logoColor=white)
